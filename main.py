...
import architech, electric, gas, fireprotection, hazard, kfs
...
class MultiApp:
    ...
    def run(self):
        ...
        with st.sidebar:   
            ...
            app = option_menu(
                menu_title='안전점검 매뉴얼',
                options=['분야를 선택하세요', '건축 피난','전기','가스','소방시설','위험물', 'KFS'],
                icons=['','buildings','plug', 'cloud-fog2','shield','droplet-fill','book'],
                menu_icon='list-task',
                default_index=0,
                styles={
